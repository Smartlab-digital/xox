...
const normalizeStoredListing = item => {
  ...
  const cameraLike=/фото|камер/i.test(`${item.title||''} ${item.category||''}`),fallback=cameraLike?'assets/listings/camera-placeholder.svg':'assets/listings/listing-placeholder.svg';
